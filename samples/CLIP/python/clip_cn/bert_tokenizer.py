...
# def bert_tokenize(texts: Union[str, List[str]], context_length: int = 77) -> np.ndarray:
def bert_tokenize(texts: Union[str, List[str]], context_length: int = 52) -> np.ndarray:
    """
