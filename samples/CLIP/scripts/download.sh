...
DATASET_URL="https://models.topsfuture.com.cn/datasets/CIFAR-100/datasets.zip"
TEST_IMAGE_URL="https://models.topsfuture.com.cn/test_image/CLIP/test_images.zip"
MODEL_URL="https://models.topsfuture.com.cn/models/CLIP/models.zip"



echo "开始下载：$DATASET_URL"
curl -o "datasets.zip" "$DATASET_URL" || { 
    echo "错误：下载失败"
    exit 1 
}
...
echo "开始下载：$TEST_IMAGE_URL"
curl -o "test_images.zip" "$TEST_IMAGE_URL" || { 
    echo "错误：下载失败"
    exit 1 
}
