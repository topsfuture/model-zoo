...
MODEL_URL="https://bj25486.apps.aliyunfile.com/disk/s/XxLkoWRmhop?domainId=bj25486"
...
get_share_token() {
    ...
    local headers=(
        ...
        "User-Agent: Mozilla/5.0 (X26; Ubuntu; Linux x86_64; rv:136.0) Gecko/20100101 Firefox/136.0"
    )
