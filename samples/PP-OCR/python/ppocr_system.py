...
def main(opt):
    ...
    save_json = "results/ppocr_system_results.json"
...
def parse_opt():
    ...
    parser.add_argument('--model_det', type=str, default='./ppocrv4_det.onnx', help='detector model path')
    parser.add_argument('--limit_side_len', type=int, default=480)
    # params for text recognizer
    parser.add_argument('--model_rec', type=str, default='./ppocrv4_rec.onnx', help='recognizer model path')
    ...
    parser.add_argument('--quantize_file_det', type=Path, default='../output_det/acuity_temp/model_float16.quantize', help='quantize path')
    parser.add_argument('--quantize_det', type=str, default='float16', help='quantize type')
