...
static const cv::Scalar COLOR_GREEN = cv::Scalar(0, 255, 0);    // 绿色
static const cv::Scalar COLOR_BLUE = cv::Scalar(255, 0, 0);     // 蓝色
static const cv::Scalar COLOR_PINK = cv::Scalar(255, 0, 255);   // 粉色
static const cv::Scalar COLOR_ORANGE = cv::Scalar(0, 165, 255); // 橙色

static const std::vector<std::pair<int, int>> COCO_SKELETON = {
    {0, 1}, {0, 2}, {1, 2}, {1, 3}, {2, 4}, {3, 5}, {4, 6}, {5, 7}, {7, 9}, {6, 8}, {8, 10}, {5, 6}, {5, 11}, {6, 12}, {11, 12}, {11, 13}, {13, 15}, {12, 14}, {14, 16}};
...
private:
    ...
    void draw_skeleton(cv::Mat &image, const YoloV8Box &obj);
