...
DOWNLOAD_MODEL_URL="https://models.topsfuture.com.cn/models/lprnet/models.zip"
DOWNLOAD_DATASET_URL="https://models.topsfuture.com.cn/datasets/ccpd/datasets.zip"
