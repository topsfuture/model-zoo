...
MODEL_URL="https://bj25486.apps.aliyunfile.com/disk/s/vtR4f65yTk4?domainId=bj25486"
...
download_aliyun_file "$MODEL_URL" "$MODEL_FILE_ID" "${ROOT_DIR}/2core-i8.zip" || { 
    log_error "Model download failed"
    exit 1 
}
unzip "${ROOT_DIR}/2core-i8.zip" -d "${ROOT_DIR}"
rm "${ROOT_DIR}/2core-i8.zip"
